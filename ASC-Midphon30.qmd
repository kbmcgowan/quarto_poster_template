...
-   If normalization happens at all, these results are inconsistent with a model of normalization that operates on a single F1/F2 measure (with or without duration) and more consistent with, e.g. @fruehwald2025vowel with sufficiently inclusive formant tracks
